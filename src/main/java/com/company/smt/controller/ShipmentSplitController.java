 ...
 */
@RestController
public class ShipmentSplitController {
    //log记录
    private Logger logger = Logger.getLogger(ShipmentSplitController.class);
    ...
    public String splitNum(@RequestBody List<ShipmentSplit> shipmentSplitList) {
        try{
            shipmentSplitService.insertShipmentSplitList(shipmentSplitList);
        } catch(Exception e){
            logger.error(e);
            return "400";
        }
